...
public class ReadMe {
	...
	public static void main(String[] args) throws Exception {
		...
		restPortInterface.addTecnology("JavaEE").addTecnology("REST").addTecnology("Json").addTecnology("Jersey")
		.addTecnology("jdbc").addTecnology("Ant").addTecnology("Jenkins").addTecnology("Weblogic").addTecnology("Oracle SQL")
		.addTecnology("Eclipse");
		...
		Project ruc = new Project("Java library to handle writing, reading, searching and downloading of Alfresco documents"
				+ " for all applications the AGEA.");
		ruc.addTecnology("Alfresco").addTecnology("Alfresco cmis query language");
		almavivaProjects.add(ruc);

		Project ismea = new Project("Analysis and developing from scratch of a Spring MVC application used for interacting "
				+ "between AGEA and Ismea.");
		ismea.addTecnology("Spring MVC").addTecnology("Thymeleaf").addTecnology("jquery").addTecnology("HTML5")
		.addTecnology("css3").addTecnology("Maven");
		almavivaProjects.add(ismea);

		Project app = new Project("REST back-end services for the mobile app 'AGEA aiuti in agricoltura', available on"
		...
		Project ldap = new Project("Analysis, design, development, and deployment of new JavaEE web application"
				+ " to handle the users registration and the accesses management to the applications and utilities "
				+ "of the Italian Forensic Police.");
		ldap.addTecnology("Struts 2").addTecnology("JSP").addTecnology("Hibernate").addTecnology("JavaEE")
		.addTecnology("C Language").addTecnology("Mozilla LDAP C SDK").addTecnology("Tomcat 6").addTecnology("mySQL");
		almavivaProjects.add(ldap);

		Project inpdap = new Project("INPDAP web portal");
		inpdap.addTecnology("Struts 1").addTecnology("EJB 2.1").addTecnology("Adobe Form Design")
		.addTecnology("Jasper Report").addTecnology("JavaEE").addTecnology("JSP");
		...
		Project almaMobile = new Project("AlmaMobile. The app allows the user to login to the intranet of AlmavivA "
				+ "company and access to his time card. The app was not endorsement in any way from AlmavivA company, "
				+ "don't use any specific webservice, it just parse the HTML data from web pages to the app.");
		...
		internship.addTecnology("C Language").addTecnology("SDL graphics library").addTecnology("Nintendo DS Hardware")
		.addTecnology("NetBeans IDE").addTecnology("Codewarrior IDE");
		...
		//							EDUCATIONS
		//************************************************************************
		Education oracle1z0 = new Education("Oracle", "19/06/2013", null, 
				"Oracle Certified Expert, Java Platform, EE 6 Web Component Developer, 1Z0-899.", null);
		Education oracle310 = new Education("Oracle", "30/05/2011", null, 
				"Oracle Certified Professional, Java SE 6 Programmer certification, 310-065.", null);
